...
class WaveletDenoiseProcessor(ImageProcessor):
    def __init__(self):
        ...
        self.description = "Denoise image using 2D wavelet transform (from imager-pipeline)"
        self.parameters = {
            "wavelet": {
                "type": "select",
...
class PipelineFlatFieldCorrectionProcessor(ImageProcessor):
    ...
    def process_multi(self, images_dict, **kwargs):
        ...
        if projection is None or gain is None or dark is None:
            raise ValueError("FFC requires projection, gain, and dark images. Connect 3 Image Input nodes.")
...
class ImageJCLAHEProcessor(ImageProcessor):
    def __init__(self):
        ...
        self.description = "ImageJ-style CLAHE (Contrast Limited Adaptive Histogram Equalization)"
        self.parameters = {
            "blocksize": {
                "type": "number",
                "default": 127,
...
class ImageJHybridMedianFilterProcessor(ImageProcessor):
    def __init__(self):
        ...
        self.description = "ImageJ Hybrid 2D Median Filter - edge-preserving, uses Plus and X kernels"
        self.parameters = {
            "kernel_size": {
                "type": "select",
                "options": [3, 5, 7],
...
class AutoThresholdProcessor(ImageProcessor):
    def __init__(self):
        ...
        self.description = "Auto threshold detection and background separation from imager-pipeline"
        self.parameters = {
            "method": {
                "type": "select",
                "options": ["auto", "valley", "otsu", "knee", "percentile_25", "secondary_peak"],
                "default": "auto",
...
class PipelineInvertProcessor(ImageProcessor):
    def __init__(self):
        ...
        self.description = "Invert image colors using the imager-pipeline method (supports float32)"
        self.parameters = {}
...
class WaveletBackgroundRemovalProcessor(ImageProcessor):
    def __init__(self):
        ...
        self.description = "Remove background using wavelet-based approach (from imager-pipeline)"
        self.parameters = {
            "wavelet": {
                "type": "select",
...
class AdvancedMedianFilterProcessor(ImageProcessor):
    def __init__(self):
        ...
        self.description = "Advanced median filtering with multiple methods from imager-pipeline"
        self.parameters = {
            "filter_type": {
                "type": "select",
                "options": [
    ...
    def process(self, image_path, **kwargs):
        ...
        result = apply_advanced_median_filter(gray, filter_type=filter_type, radius=radius)
